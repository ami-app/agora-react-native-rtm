...
export default class RtmEngine {
    ...
    /**
     * @ignore AG_RTMCHANNEL
     */
    private static readonly AG_RTMCHANNEL;
    /**
     * @ignore events
     */
     ...
     */
    on<EventName extends keyof RtmEngineEvents>(eventName: EventName, callback: RTMEventCallback): void;
    /**
     * supports platform: ios, android
